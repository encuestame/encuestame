...
@Controller
public class IndenticaConnectSocialAccount extends AbstractSocialController {
     ...
     * Consumer Key.
     */
    public @Value("${identica.consumer.key}")
    String apiKey;

    /**
     * Consumer Secret.
     */
    public @Value("${identica.consumer.secret}")
    String consumerSecret;

    /**
     * Authorize Url.
     */
    public @Value("${identica.authorizeUrl}")
    String authorizeUrl;

    /**
     * Request Token Url.
     */
    public @Value("${identica.requestToken}") String requestTokenUrl;

    /**
     * Access Token.
     */
    public @Value("${identica.accessToken}") String accessToken;
    ...
    @RequestMapping(value = "/connect/indentica", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/connect/indentica", method = RequestMethod.POST)
    public String signinTwitterGet(
        ...
        OAuth1Token requestToken = tm
                .fetchNewRequestToken("http://localhost:8080/encuestame/social/back/indentica");
        request.setAttribute(OAUTH_TOKEN_ATTRIBUTE, requestToken,
                WebRequest.SCOPE_SESSION);
        return "redirect:"
                + tm.buildAuthorizeUrl(requestToken.getValue(),
                        "http://localhost:8080/encuestame/social/back/indentica");
    }
     ...
     */
    @RequestMapping(value = "/social/back/indentica", method = RequestMethod.GET, params = "oauth_token")
