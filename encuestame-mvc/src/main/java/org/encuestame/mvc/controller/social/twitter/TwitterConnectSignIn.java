 ...
 ************************************************************************************
 */
package org.encuestame.mvc.controller.social.twitter;
...
public class TwitterConnectSignIn extends AbstractSocialController {
    ...
    public String authorizeCallback(
        ...
        OAuthToken requestToken = (OAuthToken) request.getAttribute(
     ...
     */
    public void setTwitterServiceConnect(ITwitterSocialProvider twitterServiceConnect) {
