    <div id="mainPublicLineWrapper">
          ...
          <div class="categoryMenu">
                ...
                <div style="float: left;">
                    <span><a href="#">All Surveys</a></span>
                    <span><a href="#">All TweetPoll</a></span>
                    <span><a href="#">All Poll</a></span>
                </div>
                </div>
            </div>
          ...
          <div class="item">
                <div class="img">
                        <div class="stats">
                            <div class="vote">
                                <div>
                                    <span class="count"><strong>450</strong></span>
                                    <div class="viewcount">answers</div>
                                </div>
                            </div>
                            <div class="views">
                ...
                <div class="content">
                    <h3>
                         <a href="/survey/12345">Should schools sharing $10 billion in emergency aid to rehire teachers this fall be allowed to hold onto that money for next year's budget?</a>
                    </h3>
                    <div style="padding: 2px;">
        ...
        <div class="item">
                <div class="img">
                        <div class="stats">
                            <div class="vote">
                                <div>
                                    <span class="count"><strong>1450</strong></span>
                                    <div class="viewcount">answers</div>
                                </div>
                            </div>
                            <div class="views">
                ...
                <div class="content">
                    <h3>
                         <a href="/survey/12345">Freedom of Speech Does NOT give us the right to lie.</a>
                    </h3>
                    <div style="padding: 2px;">
                ...
                <div class="img">
                        <div class="stats">
                            <div class="vote">
                                <div>
                                    <span class="count"><strong>3450</strong></span>
                                    <div class="viewcount">answers</div>
                                </div>
                            </div>
                            <div class="views">
                ...
                <div class="img">
                        <div class="stats">
                            <div class="vote">
                                <div>
                                    <span class="count"><strong>230</strong></span>
                                    <div class="viewcount">answers</div>
                                </div>
                            </div>
                            <div class="views">
