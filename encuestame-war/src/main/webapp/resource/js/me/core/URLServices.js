define([ "dojo", 
		...
		function(dojo, _ENME, _array) {
			...
			var _service_store = {
				...
				"encuestame.service.list.hashtagsAction.getAction" : _appendContext("api/survey/hashtag/$1/$2.json"),
				...
				"encuestame.service.list.tweetpoll.answer.getVotes" : _appendContext("api/tweetpoll/$1/answer/$2/votes.json"),
				...
				"encuestame.service.list.poll.setParameter" : _appendContext("api/survey/poll/$1-poll.json"),
				"encuestame.service.list.poll.getVotes" : _appendContext("api/$1/poll/votes.json"),
				"encuestame.service.comments.list" : _appendContext("api/common/comment/comments/$1.json"),
				...
				"encuestame.service.list.rate.stats" : _appendContext("api/common/frontend/$1/stats.json"),
				...
				"encuestame.service.list.getTweetPollVotes" : _appendContext("api/$1/tweetpoll/$2/votes.json"),
				...
				"encuestame.service.folder.create" : _appendContext("api/survey/folder/$1/create.json"),
				"encuestame.service.folder.update" : _appendContext("api/survey/folder/$1/update.json"),
				"encuestame.service.folder.remove" : _appendContext("api/survey/folder/$1/remove.json"),
				"encuestame.service.folder.move" : _appendContext("api/survey/folder/$1/move.json"),
				"encuestame.service.folder.list" : _appendContext("api/survey/folder/$1/list.json"),
