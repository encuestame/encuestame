define(
		...
		function(dojo, _ENME) {
			...
			var _service_store = {
				...
				"encuestame.service.list.changeStatusNotification" : _appendContext("/api/notifications/all/list.json"),
				"encuestame.service.list.userList" : _appendContext("/api/notifications/readed.json"),
				"encuestame.service.list.userList" : _appendContext("/api/admon/users.json"),
				"encuestame.service.list.userList" : _appendContext("/api/admon/users.json"),
				"encuestame.service.list.userList" : _appendContext("/api/admon/users.json"),
				"encuestame.service.list.userList" : _appendContext("/api/admon/users.json"),
