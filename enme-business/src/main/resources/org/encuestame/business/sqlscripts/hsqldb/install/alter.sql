...
alter table survey_hashtags add constraint FK9D62ED6C793D9E77 foreign key (sid) references surveys
alter table survey_hashtags add constraint FK9D62ED6CDA98FFE1 foreign key (hastag_id) references hash_tags
...
alter table tweetpoll_rate add constraint FKA76ED60FE4669675 foreign key (user_uid) references userAccount
alter table tweetpoll_rate add constraint FKA76ED60F953C854B foreign key (tweetPoll_tweet_poll_id) references tweetPoll
