...
DROP TABLE IF EXISTS access_rate;
...
DROP TABLE IF EXISTS application_connection;
...
DROP TABLE IF EXISTS emailSubscribe;
...
DROP TABLE IF EXISTS gadget_properties;
...
DROP TABLE IF EXISTS geoPoint_folder;

--
-- Table structure for table 'geoPoint_type'
--

DROP TABLE IF EXISTS geoPoint_type;
...
DROP TABLE IF EXISTS poll_folder;

--
-- Table structure for table 'poll_hashtags'
--

DROP TABLE IF EXISTS poll_hashtags;
...
DROP TABLE IF EXISTS project_geoPoint;
...
DROP TABLE IF EXISTS questions_dependencies;

--
-- Table structure for table 'questions_pattern'
--

DROP TABLE IF EXISTS questions_pattern;
...
DROP TABLE IF EXISTS question_category_questions;
...
DROP TABLE IF EXISTS question_dependence_survey;
...
DROP TABLE IF EXISTS survey_folder;
...
DROP TABLE IF EXISTS survey_group_format;
...
DROP TABLE IF EXISTS survey_pagination;
...
DROP TABLE IF EXISTS tweetPoll;

--
-- Table structure for table 'tweetPoll_Folder'
--

DROP TABLE IF EXISTS tweetPoll_Folder;

--
-- Table structure for table 'tweetpoll_hashtags'
--

DROP TABLE IF EXISTS tweetpoll_hashtags;

--
-- Table structure for table 'tweetpoll_result'
--

DROP TABLE IF EXISTS tweetpoll_result;

--
-- Table structure for table 'tweetPoll_save_published_status'
--

DROP TABLE IF EXISTS tweetPoll_save_published_status;

--
-- Table structure for table 'tweetpoll_switch'
--

DROP TABLE IF EXISTS tweetpoll_switch;
...
DROP TABLE IF EXISTS userAccount_followers;

--
-- Table structure for table 'userAccount_permission'
--

DROP TABLE IF EXISTS userAccount_permission;
