 ...
 * @since Jul 2, 2010 10:08:19 AM
 * @version $Id:$
 */
public class EnMeRssFeedMessageHandler {

    private static Logger logger = LoggerFactory.getLogger(EnMeRssFeedMessageHandler.class);
