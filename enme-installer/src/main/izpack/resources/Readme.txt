...
The **last release versions** is defined  (http://encuestame.org/wiki/display/RELEASE/), if you are interested in the **Roadmap** click (http://www.encuestame.org/issues/browse/ENCUESTAME?report=com.atlassian.jirafisheyeplugin:fisheye-projectpanel&mode=changesets#selectedTab=com.atlassian.jira.plugin.system.project%3Aroadmap-panel)
