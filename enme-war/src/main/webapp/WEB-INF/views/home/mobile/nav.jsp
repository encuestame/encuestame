...
<div class="mobile-categoryMenu">
    <div class="menu-options">
        <span class="option"><a
            href="<%=request.getContextPath()%>/home?view=survey"> <spring:message
                    code="home.type.surveys" /></a></span> <span class="option"><a
            href="<%=request.getContextPath()%>/home?view=tweetpoll"> <spring:message
                    code="home.type.tweetpoll" /></a></span> <span class="option"><a
            href="<%=request.getContextPath()%>/home?view=poll"> <spring:message
                    code="home.type.poll" /></a></span>
    </div>
    <div class="mobile-MenuHotTags">
        <span class="optionTags"><a
            href="<%=WidgetUtil.getHomeFilterPeriodParameter(request, "24")%>">
                <spring:message code="home.category.hot" />
        </a></span> <span class="optionTags"><a
