...
/**
 * SurveyDetalleId generated by hbm2java
 */
public class SurveyDetalleId implements java.io.Serializable {
	...
	public SurveyDetalleId() {
	}

	public SurveyDetalleId(int idSd, int qid, int ssid, int stid) {
		this.idSd = idSd;
		this.qid = qid;
		this.ssid = ssid;
		this.stid = stid;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SurveyDetalleId))
			return false;
		SurveyDetalleId castOther = (SurveyDetalleId) other;
